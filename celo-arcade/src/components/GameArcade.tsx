  ...
  const CarGame = ({ onEnd }: { onEnd: (score: number) => void }) => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '12px' }}>
        ...
        {state === 'play' && (<div style={{ display: 'flex', gap: '24px', marginTop: '12px' }}><button type="button" aria-label="Move left" onMouseDown={() => mv('l')} onTouchStart={() => mv('l')} style={{ width: '60px', height: '60px', background: 'linear-gradient(135deg,#0f8,#0a6)', borderRadius: '50%', border: 'none', color: '#fff', fontSize: '24px', cursor: 'pointer' }}>←</button><button type="button" aria-label="Move right" onMouseDown={() => mv('r')} onTouchStart={() => mv('r')} style={{ width: '60px', height: '60px', background: 'linear-gradient(135deg,#0f8,#0a6)', borderRadius: '50%', border: 'none', color: '#fff', fontSize: '24px', cursor: 'pointer' }}>→</button></div>)}
      </div>
    );
  };
  ...
  const SnakeGame = ({ onEnd }: { onEnd: (score: number) => void }) => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '12px' }}>
        ...
        {state === 'play' && (<div style={{ marginTop: '12px' }}><div style={{ display: 'flex', justifyContent: 'center', marginBottom: '6px' }}><button type="button" aria-label="Move up" onClick={() => chDir({ x: 0, y: -1 })} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#f66,#e55)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>↑</button></div><div style={{ display: 'flex', gap: '6px', justifyContent: 'center' }}><button type="button" aria-label="Move left" onClick={() => chDir({ x: -1, y: 0 })} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#f66,#e55)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>←</button><button type="button" aria-label="Move down" onClick={() => chDir({ x: 0, y: 1 })} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#f66,#e55)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>↓</button><button type="button" aria-label="Move right" onClick={() => chDir({ x: 1, y: 0 })} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#f66,#e55)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>→</button></div></div>)}
      </div>
    );
  };
  ...
  const SpaceGame = ({ onEnd }: { onEnd: (score: number) => void }) => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '12px' }}>
        ...
        {state === 'play' && (<div style={{ display: 'flex', gap: '10px', marginTop: '12px' }}><button type="button" aria-label="Move left" onMouseDown={() => setSx((x) => Math.max(10, x - 8))} onTouchStart={() => setSx((x) => Math.max(10, x - 8))} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#93f,#72c)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>←</button><button type="button" aria-label="Fire" onClick={shoot} onTouchStart={shoot} style={{ width: '70px', height: '50px', background: 'linear-gradient(135deg,#f44,#c22)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '12px', fontWeight: 'bold', cursor: 'pointer' }}>🔥 FIRE</button><button type="button" aria-label="Move right" onMouseDown={() => setSx((x) => Math.min(90, x + 8))} onTouchStart={() => setSx((x) => Math.min(90, x + 8))} style={{ width: '50px', height: '50px', background: 'linear-gradient(135deg,#93f,#72c)', borderRadius: '10px', border: 'none', color: '#fff', fontSize: '20px', cursor: 'pointer' }}>→</button></div>)}
      </div>
    );
  };
