...
- Keep wallet keys and seed phrases out of repository files and build logs.
- Verify the arcade contract address before sharing a production URL.
- Verify the stable token address before enabling deposits.
