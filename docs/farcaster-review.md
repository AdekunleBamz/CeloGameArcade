...
- Confirm `public/.well-known/farcaster.json` is reachable from the production domain.
- Confirm the mini app image assets load without redirects that break clients.
