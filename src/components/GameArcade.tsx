        ...
        {isConnected ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', alignItems: 'flex-end' }}>
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <button type="button" onClick={handleDisconnect} aria-label="Disconnect wallet" style={{ background: 'rgba(255,68,68,0.2)', border: '1px solid #f44', borderRadius: '16px', padding: '6px 10px', color: '#f44', fontSize: '11px', cursor: 'pointer', transition: 'all 0.2s ease-out' }}>Disconnect</button>
            </div>
          ...
          <button type="button" onClick={handleConnectClick} aria-label="Connect wallet to play" style={{ background: 'linear-gradient(135deg,#0f8,#0a6)', border: 'none', borderRadius: '16px', padding: '10px 16px', color: '#fff', fontSize: '13px', fontWeight: 'bold', cursor: 'pointer', transition: 'all 0.2s ease-out' }}>Connect Wallet</button>
        )}
      </div>
        ...
        <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '16px', padding: '20px', marginBottom: '16px', textAlign: 'center' }}>
          ...
          {hideConnectWalletButton && (
            <a
              ...
              aria-label="Add cash in MiniPay"
              title="Add cash in MiniPay"
          ...
          <a
            ...
            aria-label="Swap CELO for stablecoin on Mento"
            title="Open Mento swap"
    ...
    <div role="dialog" aria-modal="true" style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.9)', backdropFilter: 'blur(10px)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '14px' }}>
      <div style={{ background: 'linear-gradient(135deg,#1a1a3e,#0f0c29)', borderRadius: '20px', padding: '24px', maxWidth: '320px', width: '100%', border: '1px solid rgba(255,255,255,0.1)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <button type="button" onClick={connectWalletConnect} aria-label="Connect with WalletConnect" style={{ background: 'linear-gradient(135deg, #3B99FC, #2D7DD2)', border: 'none', borderRadius: '14px', padding: '16px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '12px' }}>
            <div style={{ width: '40px', height: '40px', borderRadius: '10px', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px' }}>🔵</div>
            <div style={{ textAlign: 'left' }}>
    ...
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg,#0f0c29,#302b63,#24243e)', padding: '14px', fontFamily: 'system-ui', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '20px', padding: '28px', maxWidth: '320px', width: '100%', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}><button type="button" onClick={() => setView('game')} aria-label="Play game again" style={{ flex: 1, padding: '12px', background: `linear-gradient(135deg,${game?.color},${game?.color}cc)`, border: 'none', borderRadius: '12px', color: '#000', fontSize: '14px', fontWeight: '700', cursor: 'pointer' }}>🔄 Again</button><button type="button" onClick={() => setView('home')} aria-label="Return to home screen" style={{ flex: 1, padding: '12px', background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: '12px', color: '#fff', fontSize: '14px', fontWeight: '600', cursor: 'pointer' }}>🏠 Home</button></div>
        </div>
      </div>
    );
  };
